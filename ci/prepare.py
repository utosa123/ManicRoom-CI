...
if MODE in ('windows','core'):
    ...
    patch(dst,'azahar-experimental'); patch(dst,'YW2-local-play'); patch(dst,'CIA-core'); patch(dst,'Diag-core'); patch(dst,'Cheat-experimental'); patch(dst,'Room-host-experimental'); inventory(dst,'azahar')
else:
    ...
    if MODE!='baseline':
        ...
        patch(dst,'CIA-Manic'); patch(dst/'Dependencies/Libretro','CIA-Libretro')
        patch(dst,'Diag-Manic'); patch(dst/'Dependencies/Libretro','Diag-Libretro')
        patch(dst,'Cheat-Manic')
        patch(dst,'Room-host-Manic'); patch(dst/'Dependencies/Libretro','Room-host-Libretro')
